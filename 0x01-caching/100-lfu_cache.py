...
class LFUCache(BaseCaching):
    """ BaseCache defines_:
      - overwrite functions_ 'put' and 'get' for implement
      MRU caching system_
    """
    def __init__(self):
        """ Initiliaze_
    ...
    def put(self, key, item):
        """
        Assign to_ the dictionary self.cache_data the item
        value for_ the key key
        If the_ number of items in self.cache_data is higher
        that_ BaseCaching.MAX_ITEMS:
        ...
        if key and item:
            ...
            if len(self.cache_data) > BaseCaching.MAX_ITEMS:
                # Sorted elements_ by frequency_used
                ...
                # There are more_ elements with same frequency used count?
                ...
                # Delete elements with least_frequency_used
    ...
    def get(self, key):
        """
            Return_ the value in self.cache_data linked to key
        """
